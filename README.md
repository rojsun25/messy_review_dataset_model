...
├── design/                        # Input file directory (unprocessed/raw uploads)
│   └── amazon_reviews_bi.pbix      # powerbi report
│   └── model_review_dataset.pptx   # design presentation
│   └── orchestrate_workflows.jpg   # orchestration workflow design
│   └── reviews_report.jpg          # report
...
|
├── model_training_output/          # final training data (after transforming)
│   └── training_dataset.csv        # Final cleaned and annotated CSV output
|
├── transform_output/               # Output directory for processed datasets
│   └── training_dataset.csv        # Final cleaned and annotated CSV output with added sentinment
│
